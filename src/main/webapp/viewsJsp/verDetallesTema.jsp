...
<body>
	<c:set var="verDetallesTemaView" scope="request"
		value="${verDetallesTemaView}" />
	...
	<form action="/VotacionesApp/jsp/votarTema" method="post">
		<fieldset>
			...
			<c:forEach var="nivelEstudio"
				items="${verDetallesTemaView.nivelEstudioVotos}">
    			${nivelEstudio.nombre}:
    			<c:choose>
		...
		<input type="hidden" name="tema" value="${verDetallesTemaView.idTema}">
